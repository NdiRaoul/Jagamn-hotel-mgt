...
const MetricCard = ({ title, value, pillText, pillType, subtext, icon: Icon }: any) => {
  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-2">
        <div>
          <h1 className="manrope-bold text-3xl text-jagamn-primary">Executive Overview</h1>
          <p className="text-sm text-gray-500 mt-1">Real-time consolidated metrics and critical actions.</p>
        </div>
        <div className="text-right">
          <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Last Sync</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="manrope-bold text-xl text-[#0D2137]">Financial Performance</h2>
                <p className="text-sm text-slate-500 font-medium">12-month revenue vs net profit trend analysis</p>
              </div>
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">Profit</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative w-full h-[320px] overflow-visible">
              ...
              <div className="absolute top-1/2 left-[60%] -translate-x-1/2 -translate-y-[120%] bg-white p-4 rounded-xl shadow-2xl border border-gray-100 z-10 w-48">
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-3">Sept Performance</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative rounded-3xl overflow-hidden h-64 group shadow-lg">
              <img 
                ...
                onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1542314831-c6a4d14d8c85?q=80&w=2070&auto=format&fit=crop' }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D2137]/90 via-[#0D2137]/40 to-transparent"></div>
              <div className="absolute inset-x-0 bottom-0 p-8">
                <h3 className="manrope-bold text-xl text-white mb-2">Heritage Suite Performance</h3>
                <p className="text-white/80 text-sm font-medium">Review occupancy and guest satisfaction for premium wings.</p>
              </div>
            </div>
            ...
            <div className="bg-[#F8FAFC] rounded-3xl p-8 border border-gray-100 flex flex-col justify-between">
              <div>
                <h3 className="manrope-bold text-xl text-[#0D2137] mb-2">System Status</h3>
                <p className="text-slate-500 text-sm font-medium leading-relaxed mb-6">
                  All primary hospitality modules are currently operational with nominal latency.
                </p>
              </div>
              <div className="flex items-end justify-between">
                <div className="flex gap-6">
                  <div>
                    <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">Core API</p>
                    <p className="manrope-bold text-lg text-[#F4A261]">99.98%</p>
                  </div>
                  <div>
                ...
                <div className="relative w-16 h-20 bg-transparent flex items-center justify-center">
                   ...
                   <ShieldCheck className="w-8 h-8 text-[#0D2137] relative -top-2" strokeWidth={1.5} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-4">
          <div className="bg-[#F8FAFC] rounded-3xl p-6 md:p-8 h-full border border-gray-100 flex flex-col">
            ...
            <div className="flex items-center justify-between mb-8">
              <h2 className="manrope-bold text-lg text-[#0D2137]">Critical Actions</h2>
            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-l-red-500 hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="manrope-bold text-sm text-[#0D2137] mb-2">Escalated Guest Complaint</h4>
                    <p className="text-xs text-slate-500 font-medium leading-relaxed mb-4">
                      Suite 402: Service delay & structural HVAC issue reported twice.
                    </p>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-l-[#A57850] hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex gap-4">
                  <div className="shrink-0 mt-0.5"><RefreshCcw className="w-5 h-5 text-[#A57850]" /></div>
                  <div>
                    <h4 className="manrope-bold text-sm text-[#0D2137] mb-2">Financial Sync Failed</h4>
                    <p className="text-xs text-slate-500 font-medium leading-relaxed mb-4">
                      Stripe payout sync interrupted. Manual reconciliation required for batch #8291.
                    </p>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-l-[#0D2137] hover:shadow-md transition-shadow cursor-pointer">
                <div className="flex gap-4">
                  <div className="shrink-0 mt-0.5"><ShieldAlert className="w-5 h-5 text-[#0D2137]" /></div>
                  <div>
                    <h4 className="manrope-bold text-sm text-[#0D2137] mb-2">System Audit Alert</h4>
                    <p className="text-xs text-slate-500 font-medium leading-relaxed mb-4">
                      Unusual login detected from remote IP (Frankfurt, DE). Administrative lock recommended.
                    </p>
