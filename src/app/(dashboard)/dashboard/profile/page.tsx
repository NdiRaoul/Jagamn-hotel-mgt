  ...
  return (
    <div className="space-y-12 max-w-6xl pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-3">
          ...
          <p className="text-sm text-gray-500 max-w-lg leading-relaxed">
            Manage your personal information, security settings, and stay preferences.
          </p>
        </div>
        <div className="flex items-center gap-4">
          <Button variant="outline" className="h-12 px-8 border-gray-200 text-jagamn-primary font-bold hover:bg-gray-50">
            Discard Changes
          </Button>
          <Button
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white rounded-md p-10 shadow-sm border border-gray-100 border-l-4 border-l-jagamn-primary space-y-10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="manrope-bold text-xl text-jagamn-primary">Personal Details</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                <Label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Country of Residence</Label>
                <CountrySelect
                  value={form.country}
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <p className="text-sm font-bold text-jagamn-primary">
                        {form.idType} • {form.idNumber ? `****${form.idNumber.slice(-4)}` : "Not set"}
                      </p>
                      {form.idNumber && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#E6E8EA] rounded-md p-10 space-y-6">
              <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Membership Level</p>
              <h3 className="manrope-bold text-4xl text-jagamn-primary leading-tight">Gold Elite</h3>
              <div className="space-y-3">
                <div className="h-1.5 w-full bg-gray-200 rounded-full overflow-hidden">
                  <div className="h-full bg-jagamn-tertiary rounded-full w-[75%]" />
                </div>
                <p className="text-[10px] font-bold text-gray-400 text-right uppercase tracking-widest">75% to Platinum</p>
              </div>
            </div>
            <div className="bg-white rounded-md p-10 shadow-sm border border-gray-100 border-l-4 border-l-jagamn-tertiary flex flex-col justify-between">
              <div className="space-y-1">
                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Total Palace Points</p>
                <h3 className="manrope-bold text-4xl text-jagamn-tertiary tracking-tight">24,850</h3>
              </div>
              <button className="flex items-center gap-2 text-[10px] font-bold text-jagamn-primary uppercase tracking-widest group">
                Explore Rewards <Gift className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-jagamn-primary rounded-md p-8 text-white space-y-10 shadow-xl">
            <div className="flex items-center gap-3">
              ...
              <h2 className="manrope-bold text-xl text-white">Stay Preferences</h2>
            </div>
            <div className="space-y-6">
              {[
                ...
                <div key={idx} className="flex items-center justify-between">
                  <span className="text-xs font-medium text-gray-300">{pref.label}</span>
                  <Switch checked={pref.active} className="data-[state=checked]:bg-jagamn-tertiary" />
                </div>
              ))}
            </div>
            <div className="pt-6 border-t border-white/10 space-y-2">
              <p className="text-[9px] font-bold text-gray-500 uppercase tracking-widest mb-1">Pillow Menu Choice</p>
              <p className="text-xs font-bold text-white">Egyptian Cotton • Firm Goose Down</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-md p-8 shadow-sm border border-gray-100 border-l-4 border-l-jagamn-primary space-y-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="manrope-bold text-lg text-jagamn-primary">Change Password</h2>
            </div>

            {pwMsg && <div className="bg-green-50 border border-green-200 text-green-700 text-xs px-3 py-2 rounded">{pwMsg}</div>}
            {pwError && <div className="bg-red-50 border border-red-200 text-red-700 text-xs px-3 py-2 rounded">{pwError}</div>}

            <form onSubmit={handleChangePassword} className="space-y-4">
              <div className="space-y-2">
                <Label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">New Password</Label>
                <Input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="••••••••" className="bg-gray-50 border-0 h-11" />
              </div>
              <div className="space-y-2">
                <Label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Confirm New Password</Label>
                <Input type="password" value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} placeholder="••••••••" className="bg-gray-50 border-0 h-11" />
              </div>
              <Button type="submit" disabled={isChangingPw} className="w-full h-11 bg-jagamn-primary text-white font-bold">
          ...
          <div className="relative h-[200px] rounded-md overflow-hidden shadow-sm group">
            <Image src="/images/palace-detail.png" alt="Upgrade" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
            <div className="absolute bottom-6 left-6 right-6">
              <h4 className="manrope-bold text-white text-lg leading-tight mb-1">Your Next Exclusive Upgrade</h4>
              <p className="text-[10px] text-jagamn-tertiary uppercase tracking-widest">Spa & Wellness Suite Access</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="pt-12 border-t border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-8">
        <div className="space-y-1">
          <h4 className="manrope-bold text-sm text-jagamn-primary">Account Privacy</h4>
          <p className="text-xs text-gray-500">Request a copy of your personal data or delete your account permanently.</p>
        </div>
