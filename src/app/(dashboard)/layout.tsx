  ...
  return (
    <div className="flex h-screen bg-[#F4F6F8] overflow-hidden">
      ...
      <nav className="md:hidden fixed bottom-4 left-4 right-4 z-50 bg-[#00152A] rounded-2xl shadow-2xl border border-white/10 px-2 py-2 flex items-center justify-around">
        ...
        <Link
          href="/rooms"
          className="flex flex-col items-center gap-1 px-3 py-2 rounded-xl text-gray-500  hover:text-white transition-all min-w-[52px]"
        >
      ...
      >
        {/* Header */}
        <header className="h-[80px] bg-white border-b border-gray-100 px-4 sm:px-6 md:px-10 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-4 sm:gap-12 flex-1">
            ...
            <div className="flex items-center gap-2 md:hidden">
              <div className="w-8 h-8 rounded-lg bg-[#BA722E] flex items-center justify-center flex-shrink-0 shadow-sm">
                <Crown className="w-4 h-4 text-white" />
              </div>
              <div>
                <h1 className="manrope-bold text-sm text-[#00152A] leading-tight">
                  The Palace
                </h1>
                <p className="text-[8px] text-[#BA722E] uppercase font-bold tracking-widest">
                  Luxury Guest Portal
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 sm:gap-6 ml-auto sm:ml-10">
            <NotificationBell audience="guest" />

            {/* User dropdown */}
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="flex items-center gap-2 sm:gap-3 pl-3 sm:pl-6 border-l border-gray-100 cursor-pointer group">
                  <div className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden border-2 border-gray-100 group-hover:border-[#BA722E] transition-all flex-shrink-0">
                    {userAvatar ? (
                      <Image
                        src={userAvatar}
                        alt="Profile"
                      ...
                      <div className="w-full h-full bg-jagamn-primary flex items-center justify-center text-white font-bold text-xs sm:text-sm">
                        {userName.charAt(0).toUpperCase()}
                      </div>
                    )}
                  </div>
